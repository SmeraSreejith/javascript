...
oreo=products.find(pro=>pro[1]=='oreo')//oreo=products.find(pro=>pro[1]=='oreo')[2]  
console.log(oreo[2]);//console.log(oreo);
console.log('----------------------------------------');
...
maxavailstock=products.reduce((pro1,pro2)=>pro1[3]>pro2[3]?pro1:pro2)
console.log(maxavailstock[1]);
console.log('-------------------------------------------------------');
...
price=products.some(pro=>pro[2]>=10&&pro[2]<=30)
console.log(price?'yes':'no');
console.log('-------------------------------------------------------');
